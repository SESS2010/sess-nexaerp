...
public partial class Rev868C3EmployeeDepartmentManagerReconciliation : Migration
{
    ...
    private static string BuildUpsertSql()
    {
        ...
        sb.AppendLine($"""
            ...
            values (gen_random_uuid(), 'ReconcileEmployeeDepartmentManagerWorkbook', {Sql("{\"activeEmployees\":42,\"relievedEmployees\":9,\"departments\":12,\"managerMappings\":14,\"reason\":\"Approved REV868C3 employee workbook source checkpoint\"}")}, null, 'REV868C3_EMPLOYEE_WORKBOOK_RECONCILIATION', TIMESTAMPTZ '{Stamp:yyyy-MM-ddTHH:mm:sszzz}', '{Actor}', 'REV868C3', 'EmployeeWorkbook', null, 'Employees', 'Success', null, null, 'system-migration', 0::bigint)
