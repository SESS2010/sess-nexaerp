...
expected_role_seeds("Id","Code","Name","IsPrivileged","IsActive","CreatedBy") as (values
 ...
 ('50000000-0000-0000-0000-000000000002'::uuid,'SESS','INVENTORY_VALUATION_METHOD','WEIGHTED_AVERAGE',date '2026-08-10',true,'migration-rev869a')
    ...
    ('8c9ccb5e-d2ee-b5c2-70b3-26f0805ab6d3'::uuid,'MANAGING_DIRECTOR','40000000-0000-0000-0000-000000000008'::uuid,true,true,true,true,true,false,true,true,true,true,false,false,true,true,true,true,false,true,true,true),
