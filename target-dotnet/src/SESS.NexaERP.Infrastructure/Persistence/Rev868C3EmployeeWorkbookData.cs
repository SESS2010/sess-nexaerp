...
public static class Rev868C3EmployeeWorkbookData
{
    ...
    [
        ...
        Employee("SESS-040", "1065", "NARREN S", "Male", "Degree", new(1994, 12, 2), new(2026, 2, 9), "Approximate - management instruction", "Permanent", "Senior Engineer", "Production & Quality Incharge", "Quality/QC Incharge and Primary Manager", "QUALITY_QC", "CHENNAI FACTORY", "SESS-040", "SESS-009", "ALL", "Quality"),
