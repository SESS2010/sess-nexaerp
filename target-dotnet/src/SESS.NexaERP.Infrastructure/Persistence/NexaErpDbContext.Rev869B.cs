...
public sealed partial class NexaErpDbContext
{
    ...
    private static void ConfigureRev869B(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<VendorQuotation>(entity =>
        {
            ...
            entity.Property(x => x.SubmissionSource).HasMaxLength(40).IsRequired(); entity.Property(x => x.AttachmentObjectKey).HasMaxLength(500).IsRequired(); entity.Property(x => x.AttachmentSha256).HasMaxLength(64).IsRequired(); entity.Property(x => x.VendorAttestation).HasMaxLength(2000).IsRequired(); entity.Property(x => x.LateAuthorizationRemarks).HasMaxLength(2000); entity.Property(x => x.PaymentTermsSnapshot).HasMaxLength(2000).IsRequired(); entity.Property(x => x.DeliveryTermsSnapshot).HasMaxLength(2000).IsRequired(); entity.Property(x => x.WarrantyTermsSnapshot).HasMaxLength(2000).IsRequired(); Money(entity.Property(x => x.HeaderDiscountValue)); Money(entity.Property(x => x.TotalPayableValue)); entity.Property(x => x.Version).IsConcurrencyToken();
        ...
        modelBuilder.Entity<VendorQuotationLine>(entity =>
        {
            entity.ToTable("vendor_quotation_lines", table =>
            {
                ...
                table.HasCheckConstraint("CK_vendor_quotation_line_values", "\"UnitRate\" >= 0 AND \"DiscountValue\" >= 0 AND \"HeaderDiscountValue\" >= 0 AND \"PackingForwarding\" >= 0 AND \"Freight\" >= 0 AND \"Insurance\" >= 0 AND \"OtherCharges\" >= 0 AND \"TaxableValue\" >= 0 AND \"CgstValue\" >= 0 AND \"SgstValue\" >= 0 AND \"IgstValue\" >= 0 AND \"CessValue\" >= 0 AND \"TotalPayableValue\" >= 0");
            });
            ...
            foreach (var property in new[] { entity.Property(x => x.Quantity), entity.Property(x => x.UnitRate), entity.Property(x => x.DiscountValue), entity.Property(x => x.HeaderDiscountValue), entity.Property(x => x.PackingForwarding), entity.Property(x => x.Freight), entity.Property(x => x.Insurance), entity.Property(x => x.OtherCharges), entity.Property(x => x.TaxableValue), entity.Property(x => x.CgstValue), entity.Property(x => x.SgstValue), entity.Property(x => x.IgstValue), entity.Property(x => x.CessValue), entity.Property(x => x.RoundOff), entity.Property(x => x.TotalPayableValue) }) Money(property);
            entity.Property(x => x.TaxRuleSnapshotJson).HasColumnType("jsonb").IsRequired(); Text(entity.Property(x => x.HsnSacCode), 20); Text(entity.Property(x => x.SupplierStateCode), 10); Text(entity.Property(x => x.PlaceOfSupplyStateCode), 10); Text(entity.Property(x => x.VendorRegistrationType), 40); entity.Property(x => x.Version).IsConcurrencyToken();
        ...
        modelBuilder.Entity<QuotationTechnicalVerification>(entity =>
        {
            ...
            entity.HasKey(x => x.Id); entity.HasIndex(x => x.VendorQuotationLineId).IsUnique(); Text(entity.Property(x => x.ComplianceStatus), 40); Text(entity.Property(x => x.CorrelationId), 200); entity.Property(x => x.ComplianceSnapshotJson).HasColumnType("jsonb").IsRequired(); entity.Property(x => x.Remarks).HasMaxLength(2000).IsRequired(); entity.Property(x => x.Version).IsConcurrencyToken();
        ...
        modelBuilder.Entity<CommercialComparison>(entity =>
        {
            ...
            Text(entity.Property(x => x.OrganizationId), 100); Text(entity.Property(x => x.ComparisonNumber), 64); Text(entity.Property(x => x.FinancialYear), 12); Text(entity.Property(x => x.CurrencyCode), 3); Text(entity.Property(x => x.ApprovalRoute), 40); Text(entity.Property(x => x.Status), 40); Text(entity.Property(x => x.IdempotencyKey), 200); entity.Property(x => x.ApprovalWorkflowSnapshotJson).HasColumnType("jsonb").IsRequired(); entity.Property(x => x.SingleSourceJustification).HasMaxLength(2000); entity.Property(x => x.RecommendationRemarks).HasMaxLength(2000); Money(entity.Property(x => x.TotalPayableValue)); entity.Property(x => x.Version).IsConcurrencyToken();
        ...
        {
            entity.ToTable("purchase_transaction_approval_history", table => table.HasCheckConstraint("CK_purchase_approval_history_remarks", "length(trim(\"Remarks\")) > 0")); entity.HasKey(x => x.Id); entity.HasIndex(x => new { x.CommercialComparisonId, x.CorrelationId }).IsUnique(); entity.HasIndex(x => new { x.CommercialComparisonId, x.CreatedAt }); entity.HasIndex(x => new { x.CommercialComparisonId, x.ApprovalCycle, x.StepNumber }).IsUnique().HasFilter("\"Action\" = 'Approve' AND \"StepNumber\" > 0");
            Text(entity.Property(x => x.Action), 50); Text(entity.Property(x => x.FromStatus), 40); Text(entity.Property(x => x.ToStatus), 40); Text(entity.Property(x => x.ApprovalRoute), 40); Text(entity.Property(x => x.ResolvedRoleCode), 100); Text(entity.Property(x => x.SnapshotIdentity), 64); Text(entity.Property(x => x.ActorLoginId), 256); Text(entity.Property(x => x.ActorRoleCode), 100); Text(entity.Property(x => x.CorrelationId), 200); entity.Property(x => x.Remarks).HasMaxLength(2000).IsRequired(); entity.Property(x => x.Version).IsConcurrencyToken();
        ...
        modelBuilder.Entity<PurchaseOrder>(entity =>
        {
            ...
            entity.ToTable("purchase_orders", table =>
            {
                ...
                table.HasCheckConstraint("CK_purchase_order_values", "\"TaxableValue\" >= 0 AND \"DiscountValue\" >= 0 AND \"HeaderDiscountValue\" >= 0 AND \"TaxValue\" >= 0 AND \"PackingForwarding\" >= 0 AND \"Freight\" >= 0 AND \"Insurance\" >= 0 AND \"OtherCharges\" >= 0 AND \"TotalPayableValue\" >= 0 AND \"ApprovalPolicySnapshotJson\" <> '{}'::jsonb");
                ...
                table.HasCheckConstraint("CK_purchase_order_approval_progress", "\"ApprovalCycle\" >= 0 AND \"CompletedApprovalStepCount\" >= 0 AND \"CompletedApprovalStepCount\" <= \"RequiredApprovalStepCount\" AND (\"ApprovalCycle\" = 0 OR (\"RequiredApprovalStepCount\" > 0 AND \"CreatorEmployeeId\" <> '00000000-0000-0000-0000-000000000000'::uuid AND \"ApprovalWorkflowSnapshotJson\" <> '{}'::jsonb))");
            });
            ...
            Text(entity.Property(x => x.OrganizationId), 100); Text(entity.Property(x => x.PoNumber), 64); Text(entity.Property(x => x.FinancialYear), 12); Text(entity.Property(x => x.Status), 40); Text(entity.Property(x => x.CurrencyCode), 3); Text(entity.Property(x => x.ApprovalRoute), 40); Text(entity.Property(x => x.IdempotencyKey), 200); entity.Property(x => x.PaymentTermsSnapshot).HasMaxLength(2000).IsRequired(); entity.Property(x => x.DeliveryTermsSnapshot).HasMaxLength(2000).IsRequired(); entity.Property(x => x.WarrantyTermsSnapshot).HasMaxLength(2000).IsRequired(); entity.Property(x => x.AmendmentReason).HasMaxLength(2000); entity.Property(x => x.CancellationReason).HasMaxLength(2000);
            entity.Property(x => x.ApprovalPolicySnapshotJson).HasColumnType("jsonb").IsRequired();
            entity.Property(x => x.ApprovalWorkflowSnapshotJson).HasColumnType("jsonb").IsRequired();
            foreach (var property in new[] { entity.Property(x => x.TaxableValue), entity.Property(x => x.DiscountValue), entity.Property(x => x.HeaderDiscountValue), entity.Property(x => x.TaxValue), entity.Property(x => x.PackingForwarding), entity.Property(x => x.Freight), entity.Property(x => x.Insurance), entity.Property(x => x.OtherCharges), entity.Property(x => x.RoundOff), entity.Property(x => x.TotalPayableValue) }) Money(property); entity.Property(x => x.Version).IsConcurrencyToken();
