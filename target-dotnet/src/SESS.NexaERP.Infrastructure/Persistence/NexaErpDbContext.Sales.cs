...
public sealed partial class NexaErpDbContext
{
    ...
    private static void ConfigureSales(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<CustomerPurchaseOrder>(entity =>
        {
            ...
            entity.Property(x => x.CustomerName).HasMaxLength(300).IsRequired();
            ...
            entity.Property(x => x.InvoiceNumber).HasMaxLength(200);
            entity.Property(x => x.PaymentStatus).HasMaxLength(80);
        ...
        modelBuilder.Entity<CustomerPurchaseOrderLine>(entity =>
        {
            ...
            entity.HasIndex(x => new { x.CustomerPurchaseOrderId, x.SlNo });
