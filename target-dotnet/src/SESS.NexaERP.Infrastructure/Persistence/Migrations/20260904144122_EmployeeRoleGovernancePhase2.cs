...
{
    /// <inheritdoc />
    public partial class EmployeeRoleGovernancePhase2 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(EmployeeRoleGovernancePhase2Sql.Prepare);

            migrationBuilder.CreateTable(
                name: "employee_company_role_profiles",
                schema: "advance",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    EmployeeId = table.Column<Guid>(type: "uuid", nullable: false),
                    ConfigurationStatus = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    PrimaryRoleAssignmentId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_employee_company_role_profiles", x => x.Id);
                    table.UniqueConstraint("AK_employee_company_role_profiles_CompanyId_Id", x => new { x.CompanyId, x.Id });
                    table.CheckConstraint("CK_employee_role_profile_primary", "(\"ConfigurationStatus\" = 'PENDING' AND \"PrimaryRoleAssignmentId\" IS NULL) OR (\"ConfigurationStatus\" = 'CONFIGURED' AND \"PrimaryRoleAssignmentId\" IS NOT NULL)");
                    table.ForeignKey(
                        name: "FK_employee_company_role_profiles_companies_CompanyId",
                    ...
                    table.ForeignKey(
                        name: "FK_employee_company_role_profiles_employee_role_assignments_Pr~",
                        column: x => x.PrimaryRoleAssignmentId,
                        principalSchema: "advance",
                        principalTable: "employee_role_assignments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_employee_company_role_profiles_employees_EmployeeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreviousRoleRetained = table.Column<bool>(type: "boolean", nullable: true),
            ...
            migrationBuilder.UpdateData(
                ...
                columns: new[] { "AssignmentType", "EndReason", "EndedAt", "EndedBy", "IsPrimary" },
                values: new object[] { "PERMANENT", null, null, null, false });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_employee_role_assignments_CompanyId_EmployeeId",
                schema: "advance",
                table: "employee_role_assignments",
                columns: new[] { "CompanyId", "EmployeeId" },
                unique: true,
                filter: "\"IsPrimary\" AND \"EffectiveTo\" IS NULL AND \"ApprovalStatus\" IN ('Approved','SeedApproved')");
            ...
            migrationBuilder.AddCheckConstraint(
                ...
                schema: "advance",
                table: "employee_role_assignments",
                sql: "\"EffectiveTo\" IS NULL OR \"AssignmentType\" IN ('TEMPORARY','COVER') OR (\"EndReason\" IS NOT NULL AND length(btrim(\"EndReason\")) > 0 AND \"EndedAt\" IS NOT NULL AND \"EndedBy\" IS NOT NULL)");

            migrationBuilder.AddCheckConstraint(
                name: "CK_employee_role_assignment_type",
                schema: "advance",
                table: "employee_role_assignments",
                sql: "\"AssignmentType\" IN ('PERMANENT','TEMPORARY','COVER')");

            migrationBuilder.CreateIndex(
                name: "IX_employee_company_role_profiles_CompanyId",
                schema: "advance",
                table: "employee_company_role_profiles",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_employee_company_role_profiles_CompanyId_EmployeeId",
                schema: "advance",
                table: "employee_company_role_profiles",
                columns: new[] { "CompanyId", "EmployeeId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_employee_company_role_profiles_EmployeeId",
                schema: "advance",
                table: "employee_company_role_profiles",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_employee_company_role_profiles_PrimaryRoleAssignmentId",
                schema: "advance",
                table: "employee_company_role_profiles",
                column: "PrimaryRoleAssignmentId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "employee_role_assignment_events",
                column: "EmployeeId");
            migrationBuilder.Sql(EmployeeRoleGovernancePhase2Sql.Up);
        }
        ...
        {
            PostgreSqlClusterGuard.Require(migrationBuilder);
            migrationBuilder.Sql(EmployeeRoleGovernancePhase2Sql.DownBeforeTables);
            ...
            migrationBuilder.Sql(EmployeeRoleGovernancePhase2Sql.DownAfterTables);
