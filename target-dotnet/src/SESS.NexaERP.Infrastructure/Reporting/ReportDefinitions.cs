    ...
    [
        new("machine-dossier","Delivered machine component ancestry",false,true,
            ...
            [new("machineSerial","Machine serial"),new("dcNumber","Signed DC"),new("deliveredAt","Delivered at"),new("customerSignatory","Customer signatory"),new("signatureSha256","Signature SHA-256"),
             ...
             new("fitmentId","Fitment ID"),new("reversalId","Reversal ID"),new("issueLineId","Issue line ID"),new("grnLineId","GRN line ID"),new("grnDocuments","GRNs"),new("vendors","Vendors"),new("bills","Accepted bills"),new("provenance","Provenance"),new("qcDocuments","QC inspections"),new("evidencePart","Evidence part","number"),new("evidence","Source evidence JSON")],
