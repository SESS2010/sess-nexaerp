...
public sealed record CreateOperationalScopeRequest(string OrganizationId, string EmployeeCode, string? DepartmentCode, string? WarehouseCode, Guid? RackBinId, bool AllowsPrivilegedCrossScope, DateOnly EffectiveFrom, DateOnly? EffectiveTo, string Remarks);
...
public sealed record CreateTaxGstSettingRequest(string OrganizationId, string JurisdictionCode, string HsnSacCode, string SupplyType, string VendorRegistrationType, decimal GstRate, decimal CgstRate, decimal SgstRate, decimal IgstRate, decimal CessRate, bool IsExempt, bool IsReverseCharge, string CurrencyCode, int RoundingScale, DateOnly EffectiveFrom, DateOnly? EffectiveTo, string Remarks);
...
public sealed record CreateWarehouseConditionLocationRequest(string OrganizationId, string WarehouseCode, Guid RackBinId, string ConditionCode, string Remarks);
