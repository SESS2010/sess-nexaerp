...
public sealed record StockCheckPurchaseRequisitionDetail(string PrNumber, string Status, uint Version, IReadOnlyList<StockCheckPurchaseRequisitionLine> Lines);
