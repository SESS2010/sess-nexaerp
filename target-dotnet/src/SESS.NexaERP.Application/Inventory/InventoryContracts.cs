...
public sealed record ItemSummary(Guid Id, string ItemCode, string Name, Guid? CategoryId, string? CategoryCode, string? CategoryName, Guid? SubcategoryId, string? SubcategoryCode, string? SubcategoryName, Guid BaseUomId, string Uom, string MaterialType, string ItemType, bool IsReturnable, string? ManufacturerMake, string? Model, string? PartNumber, decimal MinimumStock, decimal MaximumStock, decimal ReorderLevel, string Status, string ApprovalStatus, bool IsActive, uint Version);

public sealed record ItemDetail(Guid Id, string ItemCode, string Name, string DetailedDescription, Guid? CategoryId, string? CategoryCode, string? CategoryName, Guid? SubcategoryId, string? SubcategoryCode, string? SubcategoryName, string MaterialType, string ItemType, bool IsReturnable, Guid BaseUomId, string Uom, string? ManufacturerMake, string? Model, string? PartNumber, string? HsnSacCode, decimal GstPercentage, string? TechnicalSpecification, string? DrawingDocumentReference, bool QcRequired, bool SerialNumberTracking, bool BatchTracking, bool ShelfLifeTracking, decimal MinimumStock, decimal MaximumStock, decimal ReorderLevel, string? PreferredVendorCode, decimal? StandardEstimatedPrice, string? Barcode, string? BarcodeSymbology, string? ImageStorageKey, string? ImageFileName, string? ImageContentType, string Status, string ApprovalStatus, bool IsActive, uint Version);

public sealed record UpsertItemRequest(string ItemCode, string Name, string DetailedDescription, Guid CategoryId, Guid? SubcategoryId, string MaterialType, string ItemType, bool IsReturnable, string Uom, string? ManufacturerMake, string? Model, string? PartNumber, string? HsnSacCode, decimal GstPercentage, string? TechnicalSpecification, string? DrawingDocumentReference, bool QcRequired, bool SerialNumberTracking, bool BatchTracking, bool ShelfLifeTracking, decimal MinimumStock, decimal MaximumStock, decimal ReorderLevel, string? PreferredVendorCode, decimal? StandardEstimatedPrice, string? Barcode, string? BarcodeSymbology, string? ImageStorageKey, string? ImageFileName, string? ImageContentType, uint? Version);
