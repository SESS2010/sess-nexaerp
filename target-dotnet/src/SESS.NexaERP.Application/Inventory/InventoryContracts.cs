...
public sealed record ItemSummary(Guid Id, string ItemCode, string Name, Guid? CategoryId, string? CategoryCode, string? CategoryName, Guid? SubcategoryId, string? SubcategoryCode, string? SubcategoryName, string Uom, string MaterialType, string ItemType, bool IsReturnable, string? ManufacturerMake, string? Model, string? PartNumber, decimal MinimumStock, decimal MaximumStock, decimal ReorderLevel, string Status, string ApprovalStatus, bool IsActive, uint Version);
